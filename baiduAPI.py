...
def segmentationAPI(img_name='test.png', labelmap_name=None, foreground_name=None, scoremap_name=None):
    ...
    if not connect_response:
        raise Exception('Baidu API failed to connect')
    ...
    if not response:
        raise Exception("Baidu API no response")
...
if __name__ == "__main__":
    segmentationAPI(img_name='Images/hwr_test/composite.jpg', labelmap_name='Images/hwr_test/little_girl_labelmap.png',
                    foreground_name='Images/hwr_test/little_girl_foreground.png', scoremap_name='Images/hwr_test/little_girl_scoremap.png')
